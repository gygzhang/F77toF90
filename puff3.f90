...
!              tolerance of crit.
! ---          new guess
      do ! insert do to replace label 10, add by @creaqi 2020-02-21 17:03:21.028765
   10          denx = xkm2 - xkm1
               if(denx .eq. 0.) then
                  xkm3 = xkm2
               else
...
! ---          Always replace 1 with 2 and load new info(i.e.,3) into 2.
               ...
               xkm2 = xkm3
               sigy2 = sigy3
      enddo ! insert enddo to replace goto [10, add by @creaqi 2020-02-21 17:03:21.028765
      ! goto 10 add by @creaqi 2020-02-21 17:03:21.028765
!
   50          xpskm = xkm3
!
            endif
...
! ---          Iterate until the sigma is found to be within fractional
! ---          tolerance of crit.
      do ! insert do to replace label 5, add by @creaqi 2020-02-21 17:03:21.050823
    5          niter=niter+1
!
...
! ---          Always replace 1 with 2 and load new info(i.e.,3) into 2.
               ...
               t2l = t3l
               gm2 = alog(gm3)
      enddo ! insert enddo to replace goto [5, add by @creaqi 2020-02-21 17:03:21.050823
      ! goto 5 add by @creaqi 2020-02-21 17:03:21.050823
!
   10          t0 = t3
            endif
         endif
...
! ---          Find the correct region, denoted by the segment JSEG.
               jseg = 1
      do ! insert do to replace label 15, add by @creaqi 2020-02-21 17:03:21.050965
   15          if(sigz0.le.szbrur(jseg)) exit ! add by @creaqi break the loop goto 20 in sigtz with len equal 1
               jseg = jseg + 1
      enddo ! insert enddo to replace goto [15, add by @creaqi 2020-02-21 17:03:21.050965
      ! goto 15 add by @creaqi 2020-02-21 17:03:21.050965
!
...
! ---          Find the correct region, denoted by the segment JSEG.
               jseg = 1
      do ! insert do to replace label 25, add by @creaqi 2020-02-21 17:03:21.051071
   25          if(xkm.le.xzbrur(jseg,istab)) exit ! add by @creaqi break the loop goto 30 in sigtz with len equal 1
               jseg = jseg + 1
      enddo ! insert enddo to replace goto [25, add by @creaqi 2020-02-21 17:03:21.051071
      ! goto 25 add by @creaqi 2020-02-21 17:03:21.051071
!
...
!
   label44:      do ! insert do to replace label 30, add by @creaqi 2020-02-21 17:03:21.487922
   30 CONTINUE
         JEVAL = .TRUE.
!
...
!
      do ! insert do to replace label 180, add by @creaqi 2020-02-21 17:03:21.485772
  180    CONTINUE
!
...
!
            JEVAL = .FALSE.
      enddo ! insert enddo to replace goto [180, add by @creaqi 2020-02-21 17:03:21.485772
      ! goto 180 add by @creaqi 2020-02-21 17:03:21.485772
  290    CONTINUE
!
!        END OF THE OUTER LOOP.
!
      enddo label44! 44 continue flag 2   label44
      ! goto 30 add by @creaqi 2020-02-21 17:03:21.487922
      endif ! add by @creaqi continuation
...
!
      NEXTC = 1
      do ! insert do to replace label 50, add by @creaqi 2020-02-21 17:03:21.745508
      do ! insert do to replace label 50, add by @creaqi 2020-02-21 17:03:21.746115
...
!
         NEXTC = NEXTC + 2
      ! goto 50 add by @creaqi 2020-02-21 17:03:21.745508
...
!       PRINT
!
      enddo ! insert enddo to replace goto [50 (shift down 28), add by @creaqi 2020-02-21 17:03:21.745508
      DO I=1,NUNIT! add by @creaqi do label 60
         WRITE(IU(I), '(A)') CBUFF(1:LPREF+LPIECE)
      enddo !add by @creaqi 60
   60 CONTINUE
!
      enddo ! insert enddo to replace goto [50, add by @creaqi 2020-02-21 17:03:21.746115
      ! goto 50 add by @creaqi 2020-02-21 17:03:21.746115
      RETURN
      END
!DECK XERSVE
...
! --- Data records:  Loop over coastline(s) provided
      ...
      nsegcst=0
      icoast=0
      do ! insert do to replace label 10, add by @creaqi 2020-02-21 17:03:21.843284
...
! --- Next record
      enddo ! insert enddo to replace goto [10, add by @creaqi 2020-02-21 17:03:21.843284
      ! goto 10 add by @creaqi 2020-02-21 17:03:21.843284
